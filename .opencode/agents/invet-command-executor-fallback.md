...
- Cuando el agente padre pida reproduccion dentro de contenedor, usa `docker compose` y conserva la evidencia de esa ejecucion.
- Para pruebas de backend con base de datos, preferir el contenedor `backend` con PostgreSQL.
- Si el flujo requiere el runtime frontend, usa el servicio `frontend` del compose.
