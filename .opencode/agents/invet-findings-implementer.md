...
- Si la correccion necesita reproducir el fallo dentro de la infraestructura real, usa `docker compose` como contexto.
- Para arreglos que dependan de persistencia, valida la correccion contra PostgreSQL en el contenedor de backend.
