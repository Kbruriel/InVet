...
9. Ejecuta `python backend/scripts/validate_slice_plan.py BE-00X --stage secure-persistence` despues de completar tareas de persistencia/seguridad; si falla, corrige o deja bloqueo explicito.
10. Cambia a `- [x]` solo cuando los criterios pasen y sustituye `Evidencia: pending` por evidencia reproducible.
