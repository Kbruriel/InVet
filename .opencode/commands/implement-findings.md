...
2. Si el origen es QA, lee `docs/opencode/qa/QA-00X-findings.md`; si el origen es review, lee `docs/opencode/reviews/BE-00X-review.md`; si aplica, revisa también las tareas relacionadas.
