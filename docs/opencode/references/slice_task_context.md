...
| 008 | Solicitud y gestion de citas | Crear, confirmar, cancelar, reprogramar, marcar no-show y completar citas. | Modelo de cita, estados, disponibilidad basica, endpoints de transicion, reglas y pruebas de estado/permisos. | Flujo de solicitud desde perfil, agenda propietario, agenda clinica, cambios de estado y feedback visual. | Transiciones validas pasan; transiciones invalidas fallan; disponibilidad y permisos se respetan; notificaciones quedan preparadas si aplica. |
