...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| docs/opencode/plans/BE-008-plan.md | BE-008-T99 | docs/opencode/plans/BE-009-plan.md | BE-009-T01 | No se postergaron tareas; BE-009 inicia con planificacion limpia sin carryovers de slices anteriores. | CLOSED | system | 2026-08-18 | docs/opencode/plans/BE-009-plan.md#linea-inicio | docs/opencode/plans/BE-008-plan.md#linea-fin | docs/opencode/plans/BE-009-plan.md#linea-inicio |
...
- `source_plan`: Plan origen (ej: BE-008-plan.md)
- `source_task`: Tarea origen (ej: BE-008-T99)
- `destination_plan`: Plan destino (BE-009-plan.md)
- `destination_task`: Tarea destino (ej: BE-009-T01)
