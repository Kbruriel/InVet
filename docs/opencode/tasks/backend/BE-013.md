# BE-013 — Notificaciones internas y correo

## Objetivo

Notificaciones internas y correo para eventos MVP.

## Dependencias

- BE-012, FE-012, QA-012 cerrados.
...
- Implementar únicamente capacidades necesarias para el slice `013`.
...
- El contrato requerido por `FE-013` existe o queda documentado como mock temporal aprobado.
