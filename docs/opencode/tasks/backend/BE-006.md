...
CRUD servicios, veterinarios, usuarios internos y asociación a sucursal/servicio.

## Dependencias

- BE-005, FE-005, QA-005 cerrados.
- Revisar matriz en `docs/opencode/02_be_fe_qa_task_matrix.md`.
- Frontend relacionado: `FE-006`.
- QA relacionado: `QA-006`.

## Alcance MVP

- Implementar únicamente capacidades necesarias para el slice `006`.
...
- El contrato requerido por `FE-006` existe o queda documentado como mock temporal aprobado.
