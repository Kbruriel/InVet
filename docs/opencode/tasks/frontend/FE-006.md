# FE-006 — Servicios, veterinarios y usuarios internos

## Objetivo

Vistas admin para servicios, veterinarios y usuarios internos.
...
- Implementar UI y consumo API del slice `006`.
