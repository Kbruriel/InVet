# FE-012 — Calificaciones y comentarios

## Objetivo

UI de calificación propietario, comentarios en perfil y respuesta clínica.
...
- Implementar UI y consumo API del slice `012`.
...
- [x] Rutas implementadas. (`app/clinic/reviews/page.tsx`, `app/clinic/reviews/[reviewId]/respond/page.tsx`)
- [x] Componentes implementados. (`features/reviews/`: RatingForm, ReviewPublicList, ReviewStaffList, ReviewRespondForm)
- [x] Estados UX implementados. (5 estados loading/success/error/empty/validation — jest 51 passed)
- [x] Validaciones implementadas. (rating 1-5, comentario/response max 2048, estados de error)
- [x] Consumo API centralizado. (`shared/api/review.ts`)
