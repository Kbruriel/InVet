# FE-004 — Perfil público clínica/sucursal

## Objetivo

Página de perfil público con CTA solicitud cita y datos públicos.
...
- Implementar UI y consumo API del slice `004`.
