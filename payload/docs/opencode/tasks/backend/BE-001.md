# BE-001 — Base técnica y design system

## Objetivo

Base técnica backend, healthcheck, configuración, roles seed inicial y estructura Clean Architecture.
...
- Implementar únicamente capacidades necesarias para el slice `001`.
