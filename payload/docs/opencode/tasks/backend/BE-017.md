# BE-017 — Hardening E2E MVP

## Objetivo

Ajustes integrales, seed demo, errores, auditoría mínima y documentación OpenAPI.

## Dependencias

- BE-016, FE-016, QA-016 cerrados.
- Revisar matriz en `docs/opencode/02_be_fe_qa_task_matrix.md`.
- Frontend relacionado: `FE-017`.
- QA relacionado: `QA-017`.

## Alcance MVP

- Implementar únicamente capacidades necesarias para el slice `017`.
...
- El contrato requerido por `FE-017` existe o queda documentado como mock temporal aprobado.
