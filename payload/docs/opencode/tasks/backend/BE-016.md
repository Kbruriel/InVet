# BE-016 — Administración inicial del sistema

## Objetivo

Admin usuarios, clínicas, activación, términos, privacidad, soporte y reportes globales básicos.

## Dependencias

- BE-015, FE-015, QA-015 cerrados.
- Revisar matriz en `docs/opencode/02_be_fe_qa_task_matrix.md`.
- Frontend relacionado: `FE-016`.
- QA relacionado: `QA-016`.

## Alcance MVP

- Implementar únicamente capacidades necesarias para el slice `016`.
...
- El contrato requerido por `FE-016` existe o queda documentado como mock temporal aprobado.
