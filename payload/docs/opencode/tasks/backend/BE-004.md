...
Endpoint de perfil público, servicios, horarios, ratings resumidos y disponibilidad básica.

## Dependencias

- BE-003, FE-003, QA-003 cerrados.
- Revisar matriz en `docs/opencode/02_be_fe_qa_task_matrix.md`.
- Frontend relacionado: `FE-004`.
- QA relacionado: `QA-004`.
...
- El contrato requerido por `FE-004` existe o queda documentado como mock temporal aprobado.
