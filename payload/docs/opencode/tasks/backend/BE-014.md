# BE-014 — Soporte básico

## Objetivo

Solicitudes de soporte, categorías, estados y consulta.

## Dependencias

- BE-013, FE-013, QA-013 cerrados.
...
- Implementar únicamente capacidades necesarias para el slice `014`.
...
- El contrato requerido por `FE-014` existe o queda documentado como mock temporal aprobado.
