"""Pruebas de autenticación y autorización (C2, C9).

Cubren:
- C2: Creación de notificación al crear una reseña (se prueba con el endpoint de emisión)
...
def test_all_endpoints_require_authentication(app_client):
    ...
    endpoints = [
        ...
        ("/api/v1/notifications/count/unread", "GET"),
