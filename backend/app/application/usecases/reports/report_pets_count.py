...
def report_pets_count(
    ...
    return PaginatedResponse(
        items=[PetCountDto(clinic_id=clinic_id, active_count=count)],  # type: ignore[arg-type]
        total=count,
        page=1,
        size=1,
    )
