...
from app.api.v1.routers.reports_router import router as reports_router
...
from app.api.v1.routers.support_ticket_router import router as support_ticket_router
...
router.include_router(support_ticket_router)
