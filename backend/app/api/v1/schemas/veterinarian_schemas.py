...
class VeterinarianCreateSchema(BaseModel):
    ...
    nombre_completo: str = Field(
        ..., min_length=1, max_length=200, description="Nombre completo del veterinario"
    )
    licencia_profesional: str = Field(
        ..., min_length=1, max_length=100, description="Licencia profesional"
    )
    especialidad: str = Field(
        ..., min_length=1, max_length=200, description="Especialidad"
    )
