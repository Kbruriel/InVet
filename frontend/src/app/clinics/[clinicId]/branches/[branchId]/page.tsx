...
export default async function ProtectedClinicBranchPage({ params }: Params) {
  ...
  return (
    <ProtectedClinicBranchClient clinicId={parseInt(clinicId, 10)} branchId={parseInt(branchId, 10)} />
  )
}

function ProtectedClinicBranchClient({ clinicId, branchId }: { clinicId: number; branchId: number }) {
